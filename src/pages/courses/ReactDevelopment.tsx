  ...
  return (
    <>
      ...
      <ParallaxHero 
        ...
        subtitle="Master React and React Native to build web and mobile applications"
        backgroundImage="https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=1920&q=80"
      />
        ...
        <AnimatedSection className="py-20">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <div className="bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl p-8 mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-navy mb-4">Build Modern Web & Mobile Apps</h2>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Learn React and React Native to create powerful web applications and cross-platform 
                    mobile apps. Master component-based architecture, state management, and modern 
                    development practices that are industry standard.
                  </p>
                </div>
            ...
            <AnimatedSection className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl p-12 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Start Building React Apps Today!</h3>
