...
const PracticalMachineLearning = () => {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <ParallaxHero 
        ...
        subtitle="Hands-on training in building and deploying machine learning models for real-world applications"
        ...
        <AnimatedSection className="py-20">
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <div className="bg-gradient-to-br from-green-100 to-green-200 rounded-2xl p-8 mb-8">
                  ...
                  <h2 className="text-3xl font-bold text-navy mb-4">Build Intelligent Applications</h2>
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Learn to build, train, and deploy machine learning models that solve real-world 
                    problems. Master the complete ML pipeline from data collection to production 
                    deployment with hands-on projects and industry best practices.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="flex items-center gap-3 bg-gray-50 p-4 rounded-lg">
                    ...
                    <div>
                      <div className="font-semibold text-navy">300+</div>
            ...
            <AnimatedSection className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-12 text-white text-center">
              <h3 className="text-3xl font-bold mb-4">Start Your ML Journey Today!</h3>
...
export default PracticalMachineLearning;
